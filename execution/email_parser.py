...
MANUAL_PRICE_CODES = {
    'CASH-849182-A',  # manual cash: Cristian 55€
    'CASH-849182-B',  # manual cash: Carlos 75€
    'FH343696332',    # split: Cristian benefit 43.18 (not full 118.18)
    'GYGKBGGG2K3Q',  # split: Cristian benefit 60 (not full 119.30)
}
